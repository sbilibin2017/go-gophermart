...
func (m *MockOrderRegisterOrderExistsRepository) Exists(ctx context.Context, orderID *repositories.OrderExistsFilterDB) (bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockOrderRegisterOrderSaveRepository) Save(ctx context.Context, order *repositories.OrderSaveDB) error {
	m.ctrl.T.Helper()
...
func (m *MockOrderRegisterRewardFilterRepository) Filter(ctx context.Context, filter *repositories.RewardFilterDB) (*repositories.RewardFilteredDB, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Filter", ctx, filter)
	ret0, _ := ret[0].(*repositories.RewardFilteredDB)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
