...
// Source: /home/sergey/Go/go-gophermart/internal/usecases/register_reward.go
...
func (m *MockRegisterRewardValidator) Struct(i interface{}) error {
	m.ctrl.T.Helper()
...
func (mr *MockRegisterRewardValidatorMockRecorder) Struct(i interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Struct", reflect.TypeOf((*MockRegisterRewardValidator)(nil).Struct), i)
}
