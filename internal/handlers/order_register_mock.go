...
func (m *MockOrderRegisterUsecase) Execute(ctx context.Context, req *usecases.OrderRegisterRequest) (*usecases.OrderRegisterResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Execute", ctx, req)
	ret0, _ := ret[0].(*usecases.OrderRegisterResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
