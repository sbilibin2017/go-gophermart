...
func (m *MockRegisterRewardValidator) Struct(s any) error {
	m.ctrl.T.Helper()
...
func (mr *MockRegisterRewardValidatorMockRecorder) Struct(s interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Struct", reflect.TypeOf((*MockRegisterRewardValidator)(nil).Struct), s)
}
