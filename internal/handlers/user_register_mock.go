...
func (m *MockUserRegisterService) Register(ctx context.Context, req *types.UserRegisterRequest) (string, *types.APIStatus, *types.APIStatus) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Register", ctx, req)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(*types.APIStatus)
	ret2, _ := ret[2].(*types.APIStatus)
	return ret0, ret1, ret2
}

// Register indicates an expected call of Register.
func (mr *MockUserRegisterServiceMockRecorder) Register(ctx, req interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Register", reflect.TypeOf((*MockUserRegisterService)(nil).Register), ctx, req)
}
