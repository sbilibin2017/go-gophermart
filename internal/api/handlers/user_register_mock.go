...
func (m *MockDecoder) Decode(r *http.Request, v any) error {
	m.ctrl.T.Helper()
...
func (mr *MockDecoderMockRecorder) Decode(r, v interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Decode", reflect.TypeOf((*MockDecoder)(nil).Decode), r, v)
}
